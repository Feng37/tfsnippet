...
Note that variational lower bound estimators are just special cases of
variational estimators, thus we may adopt the much more general ways to
do estimation, once it is possible.
"""
